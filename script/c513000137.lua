...
function c513000137.initial_effect(c)
	...
	e4:SetTarget(c513000137.atktg)
	e4:SetValue(c513000137.atkval)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	e5:SetCode(EFFECT_SET_DEFENSE_FINAL)
	e5:SetValue(c513000137.defval)
	c:RegisterEffect(e5)
	...
	e8:SetOperation(c513000137.sumsuc)
	c:RegisterEffect(e8)
	--control
	...
	e11:SetValue(c513000137.efilter)
	...
	e10:SetValue(c513000137.tgfilter)
	...
	e13:SetCountLimit(1)
	e13:SetOperation(c513000137.atkdefresetop)
...
function c513000137.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	Duel.SetChainLimitTillChainEnd(c513000137.chainlm)
end
function c513000137.chainlm(e,rp,tp)
	return e:GetHandler():IsAttribute(ATTRIBUTE_DEVINE)
end
function c513000137.efilter(e,te)
	return te:IsActiveType(TYPE_EFFECT) and te:GetOwner()~=e:GetOwner() and not te:GetHandler():IsAttribute(ATTRIBUTE_DEVINE)
end
function c513000137.tgfilter(e,re)
...
function c513000137.tgg(c,card)
...
function c513000137.atkdefresetop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tgg=Duel.GetMatchingGroup(c513000137.tgg,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil,c)
	eqg:Merge(tgg)
	if eqg:GetCount()>0 then
		Duel.Destroy(eqg,REASON_EFFECT)
	end
end
function c513000137.indes(e,re,rp)
