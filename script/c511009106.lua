...
function c511009106.spfilter1(c,e)
    return c:IsCanBeFusionMaterial() and not c:IsImmuneToEffect(e)
end
function c511009106.spfilter2(c,e,tp,m,f,gc)
...
function c511009106.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if chk==0 then
        ...
        local res=Duel.IsExistingMatchingCard(c511009106.spfilter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,mg1,nil,c)
        if not res then
            ...
            if ce~=nil then
                ...
                res=Duel.IsExistingMatchingCard(c511009106.spfilter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,mg2,mf,c)
            end
        end
        return res
    end
...
function c511009106.spop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local mg1=Duel.GetMatchingGroup(c511009106.spfilter1,tp,LOCATION_MZONE,0,c,e)
    local sg1=Duel.GetMatchingGroup(c511009106.spfilter2,tp,LOCATION_EXTRA,0,nil,e,tp,mg1,nil,c)
    local mg2=nil
    local sg2=nil
    local ce=Duel.GetChainMaterial(tp)
    if ce~=nil then
