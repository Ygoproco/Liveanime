...
function c100000501.mfilter(c,e)
	return c:IsCanBeFusionMaterial() and (c:IsSetCard(0x5008) or c:IsCode(27780618)) and c:IsAbleToRemove() and (not e or not c:IsImmuneToEffect(e))
end
...
function c100000501.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	tc:SetMaterial(g1)
	Duel.Remove(g1,POS_FACEUP,REASON_MATERIAL+REASON_FUSION+REASON_EFFECT)
	Duel.BreakEffect()
